...
public class Repository {
    ...
    private final static String getPlayerScoreURI = "https://follow.leafwaysco.com/arabic/set_score.php";
    ...
    public void getPlayerTotalScore(int userID, Connectivity.ResponseHandler responseHandler) {
        Connectivity.CommunicationWithAPI(getPlayerScoreURI,null,responseHandler);
    }
